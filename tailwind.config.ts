  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, hsl(222 47% 11%) 0%, hsl(263 70% 20%) 50%, hsl(199 89% 15%) 100%)",
        "card-gradient": "linear-gradient(135deg, hsl(222 47% 11% / 0.8) 0%, hsl(217 33% 17% / 0.6) 100%)",
